...
class LazPreprocessing(object):
    ...
    def __call__(self):
        ...
        point_cloud = laspy.read(self.path_to_data+'data/LazFilesWithHeightParam/'+self.filename+'_hag_nn.laz', laz_backend=laspy.compression.LazBackend.LazrsParallel)
