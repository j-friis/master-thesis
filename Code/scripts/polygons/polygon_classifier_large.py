...
if __name__ == "__main__":
    ...
    params = {
            ...
            "canny_lower": Integer(50,70),
            "canny_upper": Integer(150,200),
            "hough_lines_treshold": Integer(80,120),
            "min_line_length": Integer(4,15),
            "max_line_gap": Integer(75,100),
            "closing_kernel_size": Integer(1,3),
            "meters_around_line": [10],
            "simplify_tolerance": Integer(5,15),
            "cc_area": Integer(10000, 50000)
    }
