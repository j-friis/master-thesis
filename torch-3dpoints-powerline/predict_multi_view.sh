...
data_path="~/data"
height_filter=3.5
model_path="~/Documents/msc/torch-3dpoints-powerline/outputs/2023-05-19/03-32-05/ResUNet18.pt"
model_metric="miou"
cnn2d_path="~/Documents/msc/torch-3dpoints-powerline/models/preprocess_CNN/cnnStateDict.pth"
