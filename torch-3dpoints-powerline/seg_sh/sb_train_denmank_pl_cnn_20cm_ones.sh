...
model_name=SEUNet18 data=segmentation/den_pl_cnn_20cm_ones \
training.wandb.log=True training.wandb.project=NewDenmark-Seg-modified training.wandb.name=New_CNN_SEUNet18_20cm_ones_500 \
