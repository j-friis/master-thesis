...
model_name=ResUNet50 data=segmentation/den_pl_hough_small_20cm_ones \
training.wandb.log=True training.wandb.project=NewDenmark-Seg-modified training.wandb.name=minkowski_powerline_segmentation_ResUNet50_20cm_ones \
