...
model_name=ResUNet18 data=segmentation/den_pl_hough_small_20cm_ones \
training.wandb.log=True training.wandb.project=NewDenmark-Seg-modified training.wandb.name=HOUGH_ResUNet18_20cm_ones \
